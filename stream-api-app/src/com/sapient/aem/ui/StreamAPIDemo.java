	...
	public static void main(String[] args) {
     ...
     System.out.println("reduce() example..");
		...
		if(optional.isPresent()) {
			...
			int result= optional.get(); //auto-unboxing
			System.out.println(result);
		}else {
			System.out.println("No result");

		}
		System.out.println("Special types of reducers..");
		System.out.println("min() and  max() example..");
		
		
		/*
		 * Returns an OptionalInt describing the minimum element of thisstream, 
